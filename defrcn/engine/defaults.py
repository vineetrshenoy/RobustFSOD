...
def default_argument_parser():
    ...
    parser.add_argument(
        "--tags", type=str, nargs=1, default='icdR50-1', help="tag for wandb experiments"
    )
...
class DefaultTrainer(SimpleTrainer):
    ...
    def train(self):
        ...
        if hasattr(self, "_last_eval_results") and comm.is_main_process():
            ...
            wandb.log(self._last_eval_results)
            wandb.finish()
            return self._last_eval_results
    ...
    def build_optimizer(cls, cfg, model):
        ...
        """
        logger.info('cfg.SOLVER.WEIGHT_DECAY: {}'.format(cfg.SOLVER.WEIGHT_DECAY))
